...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Custom App'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'cac4d57e559a6bd65154d56f33cd3d0f'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'f0be1548f076d792ec88e245bb892fc4'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,write_script_tags,read_customers,
    write_customers'),
    ...
    */
    ...
    'webhooks' => [
           /*  [
                ...
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'http://app.liftoffcard.com/webhook/app-uninstalled')
            ]*/
